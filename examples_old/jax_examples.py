...
from easyCore.Objects.jax.Variable import PrimalValue, Descriptor, Parameter
from easyCore.Objects.ObjectClasses import BaseObj

clss = [PrimalValue, Descriptor, Parameter]
...
class _COS(BaseObj):
    ...
    def __call__(self, x):
        return self.amplitude.raw_value * np.cos(x/self.period.raw_value - self.phase.raw_value)
    ...
    def from_pars(cls, amp, phase, period):
        return cls('cosine', Parameter('amplitude', amp), Parameter('phase', phase), Parameter('period', period))
