...
from typing import Callable, TypeVar, Iterable, Optional, List, Union, Tuple, Any, Type, Dict, NoReturn
...
class Model:
    ...
    @property
    def parameter_history(self, parameter_name: Optional[Union[str, List[str]]] = None) -> Dict[str, List[float]]:
...
class CompositeModel(Model):
    def __init__(self, left_model: Model, right_model: Model,
                 function: Callable, fn_kwargs: Optional[Dict[str, Any]] = None):
