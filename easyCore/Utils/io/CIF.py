...
from easyCore.Utils.io.star import StarCollection, StarEntry, StarLoop, FakeItem
    ...
    def _sanitize_loop(self, data: StarLoop) -> StarLoop:
        ...
        if "atom_site_type_symbol" in data.labels:
            ...
            for idx, this_data in enumerate(data.data):
                ...
                # symbol are equal.
                if len(this_data._kwargs["_atom_site_type_symbol"].raw_value.split(' + ')) > \
                        len(this_data._kwargs["_atom_site_label"].raw_value.split(' + ')):
                    ...
                    # in "els_occu"
                    symbol_str = this_data._kwargs["_atom_site_type_symbol"].raw_value
                    ...
                    x = this_data._kwargs["_atom_site_fract_x"].raw_value
                    y = this_data._kwargs["_atom_site_fract_y"].raw_value
                    z = this_data._kwargs["_atom_site_fract_z"].raw_value
