...
setup(
    ...
    install_requires=['asteval==0.*,>=0.9.21', 'bumps==0.*,>=0.8.0', 'dfo-ls==1.*,>=1.2.1', 'lmfit==1.*,>=1.0.0', 'matplotlib==3.*,>=3.2.2', 'monty>=4,<2022', 'numpy==1.*,>=1.19.0', 'pint==0.*,>=0.16.0', 'uncertainties==3.*,>=3.1.0', 'xarray==0.*,>=0.16.2'],
